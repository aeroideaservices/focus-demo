...
import {
  ...
  apiGetModelElement,
  apiPutModelElement,
} from '@/api/models_v2/modelElement';
import {
  apiAddModelElements,
  apiDelModelElements,
  apiGetModelElementsList,
} from '@/api/models_v2/modelElements';
import { apiGetModelExport, apiPostModelExport } from '@/api/models_v2/modelExport';
import { apiGetModel } from '@/api/models_v2/models';
...
// Selectors
type TSelectorState = { model_v2: IModelState };

// Statuses
export const selectFetchingGetModel = (state: TSelectorState) =>
  state.model_v2.status.fetchingGetModel;
export const selectFetchingGetModelElements = (state: TSelectorState) =>
  state.model_v2.status.fetchingGetModelElements;
export const selectFetchingDelModelElements = (state: TSelectorState) =>
  state.model_v2.status.fetchingDelModelElements;
export const selectFetchingAddModelElement = (state: TSelectorState) =>
  state.model_v2.status.fetchingAddModelElement;
export const selectFetchingGetModelElement = (state: TSelectorState) =>
  state.model_v2.status.fetchingGetModelElement;
export const selectFetchingPutModelElement = (state: TSelectorState) =>
  state.model_v2.status.fetchingPutModelElement;
export const selectFetchingDelModelElement = (state: TSelectorState) =>
  state.model_v2.status.fetchingDelModelElement;
export const selectFetchingGetExportModel = (state: TSelectorState) =>
  state.model_v2.status.fetchingGetExportModel;

// Modals
export const selectDelModelElementModal = (state: TSelectorState) =>
  state.model_v2.modals.delModelElementModal;
export const selectNewModelElementModal = (state: TSelectorState) =>
  state.model_v2.modals.newModelElementModal;
export const selectEditModelElementModal = (state: TSelectorState) =>
  state.model_v2.modals.editModelElementModal;

export const selectModelName = (state: TSelectorState) => state.model_v2.modelName;
export const selectModelViewsList = (state: TSelectorState) =>
  state.model_v2.modelViews?.list.fields;
export const selectModelViewsCreate = (state: TSelectorState) => state.model_v2.modelViews?.create;
export const selectModelViewsUpdate = (state: TSelectorState) => state.model_v2.modelViews?.update;
export const selectModelViewsFilter = (state: TSelectorState) => state.model_v2.modelViews?.filter;
export const selectModelElements = (state: TSelectorState) => state.model_v2.modelElements;
export const selectModelElementsTotal = (state: TSelectorState) =>
  state.model_v2.modelElementsTotal;
export const selectModelElementsSelected = (state: TSelectorState) =>
  state.model_v2.modelElementsSelected;
export const selectCurrentModelElement = (state: TSelectorState) =>
  state.model_v2.currentModelElement;
export const selectCurrentModelElementData = (state: TSelectorState) =>
  state.model_v2.currentModelElementData;
export const selectModelExport = (state: TSelectorState) => state.model_v2.modelExport;
